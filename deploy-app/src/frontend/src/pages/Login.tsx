import { Box, Button, Container, CssBaseline, Grid, Paper, TextField, Typography, styled } from "@mui/material";
  ...
  return (
    <Grid container component="main" sx={{ height: '100vh', margin: 0, padding: 0 }}>
      ...
      <StyledGridItem item xs={12} sm={8} md={5} sx={{
        ...
        <Paper elevation={6} square sx={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#282a3a' }}>
